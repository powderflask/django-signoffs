...
* Your django and python versions.
...
Ready to contribute? Here's how to set up `django_signoffs` for local development.

1. Fork the `django_signoffs` repo on GitHub.
...
To run a subset of tests::
    ...
    $ python -m unittest tests.test_django_signoffs
