...
class ServiceDescriptor:
    ...
    def __init__(self, service_class=None, **kwargs):
        """
        Inject service_class instances into the instances of the descriptor's owner class
        first positional arg for service_class constructor must be an instance of owner class
