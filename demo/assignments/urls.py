...
widget_urlpatterns = [
    ...
    path("widget/sign-signoff/", htmx_views.sign_approval_signoff, name="sign-signoff"),
    ...
    path("widget/update-oob-content/", htmx_views.update_oob_content, name="update-oob-content"),
    path("widget/test-messages/", htmx_views.test_messages, name="test-messages"),
]
